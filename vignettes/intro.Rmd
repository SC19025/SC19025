...
__SC19025__ is a simple R package including all my homework and two new functions for nonparametric hypothesis testing(the tests for independence and symmetry). Next I will show these functions.

## Independence and symmetry testing by nonparametric methods

I will illustrate the usage of the two functions you implemented by  several examples.

For the independence test. The two elements in data faithful are dependent.
...
We can see that the test shows that the two data vectors are dependent.
...
We can see that for the symmetric distribution(Normal) and the asymmetric distribution(Normal with mean=0.5),this test made the right judgment.
